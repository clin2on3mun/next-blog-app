...
export const BlogItem = ({image, category, title, description,id}) => {
  return (
    <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0_#000000]'>
        ...
        <div className="p-5">
            ...
            <p className="mb-3 text-sm tracking-tight text-gray-900" dangerouslySetInnerHTML={{__html: description.slice(0,120)}}></p>
            <Link href={`/blogs/${id}`}>
